    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('month_of_bill', models.PositiveSmallIntegerField(verbose_name='Miesiąc rozliczeniowy')),
                ('year_of_bill', models.PositiveSmallIntegerField(verbose_name='Rok rozliczeniowy')),
